...
| ファイル                 | 内容                                                | テンプレート                                      |
| ------------------------ | --------------------------------------------------- | ------------------------------------------------- |
| `ui-design.md`           | 画面一覧・項目・操作・遷移・バリデーション・メッセージ | `templates/detailed-design/ui-design.md`          |
| `functional-design.md`   | サブ機能、入出力、処理ロジック、例外処理            | `templates/detailed-design/functional-design.md`  |
| `state-transition.md`    | 状態・イベント・遷移図 (Mermaid stateDiagram)       | `templates/detailed-design/state-transition.md`   |
| `db-design.md`           | ER図・テーブル定義・インデックス・制約・ライフサイクル | `templates/detailed-design/db-design.md`          |
| `sequence.md`            | 主要ユースケースのシーケンス図 (Mermaid sequence)   | `templates/detailed-design/sequence.md`           |

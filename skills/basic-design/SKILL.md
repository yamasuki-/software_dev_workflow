...
| ファイル                 | 内容                                   | テンプレート                                      |
| ------------------------ | -------------------------------------- | ------------------------------------------------- |
| `system-overview.md`     | システム目的・スコープ・用語・前提条件 | `templates/basic-design/system-overview.md`       |
| `feature-list.md`        | 機能一覧 (機能ID付与・要件マッピング)  | `templates/basic-design/feature-list.md`          |
| `system-architecture.md` | 全体構成図・構成要素・連携・ADR        | `templates/basic-design/system-architecture.md`   |
| `non-functional.md`      | 非機能要件 (性能/可用性/セキュリティ等) | `templates/basic-design/non-functional.md`        |
...
2. 各機能について、テンプレート `templates/progress/feature.json` をコピーして `.dev-workflow/features/<FID>/status.json` を作成。`feature_id`, `name`, `summary`, `depends_on`, タイムスタンプを埋める。

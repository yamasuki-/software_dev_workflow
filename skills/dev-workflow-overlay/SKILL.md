...
- インストール済みのベース Skill (`~/.claude/skills/dev-workflow/`) と Agent 群 (`~/.claude/agents/requirements/`, `~/.claude/agents/basic-design/`, `~/.claude/agents/implementation/`, ... の 26 個)、ただし `dev-workflow-overlay` 自身を除く
